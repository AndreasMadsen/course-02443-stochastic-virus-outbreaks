...
class Simulator:
    ...
    def __init__(self, init_state,
        ...
        self.moskva = collections.Counter()
    ...
    def _transfer_sir(self, from_sir, connected_sir):
        ...
        for total_transfer, to_sir in zip(transfer_people, connected_sir):
            ...
            if from_sir.current.region_id == 1382:
                self.moskva[to_sir.current.region_id] -= total_transfer
            elif to_sir.current.region_id == 1382:
                self.moskva[from_sir.current.region_id] += total_transfer
